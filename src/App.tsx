...
function App() {
  ...
  // решить проблему с hover на списке персон
  // особенно на ширине 437px
  // заменить на клик на определенной ширине

  // что-то с footer придумать

  // придумать что делать с пагинацией на меленьких эеранах (показывать меньше страниц?)
